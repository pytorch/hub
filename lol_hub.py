...
_DEFAULT_SECURITY = os.environ["DEFAULT_SECURITY"]
if _DEFAULT_SECURITY == "True":
    _DEFAULT_SECURITY = True
if _DEFAULT_SECURITY == "False":
...
def load(repo_or_dir, model, *args, source='github', trust_repo=_DEFAULT_SECURITY, force_reload=False, verbose=True,
