...
```python
import torch
model = torch.hub.load('pytorch/vision:v0.14.1', 'fcn_resnet50', weights="COCO_WITH_VOC_LABELS_V1")
# or
# model = torch.hub.load('pytorch/vision:v0.14.1', 'fcn_resnet101', weights="COCO_WITH_VOC_LABELS_V1")
model.eval()
```
