...
import torch
# load WRN-50-2:
model = torch.hub.load('pytorch/vision:v0.14.1', 'wide_resnet50_2', weights="IMAGENET1K_V1")
# or WRN-101-2
model = torch.hub.load('pytorch/vision:v0.14.1', 'wide_resnet101_2', weights="IMAGENET1K_V1")
model.eval()
```
