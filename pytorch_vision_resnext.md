...
```python
import torch
model = torch.hub.load('pytorch/vision:v0.14.1', 'resnext50_32x4d', weights="IMAGENET1K_V1")
# or
# model = torch.hub.load('pytorch/vision:v0.14.1', 'resnext101_32x8d', weights="IMAGENET1K_V1")
model.eval()
```
