...
```python
import torch
model = torch.hub.load('pytorch/vision:v0.14.1', 'resnet18', weights="IMAGENET1K_V1")
# or any of these variants
# model = torch.hub.load('pytorch/vision:v0.14.1', 'resnet34', weights="IMAGENET1K_V1")
# model = torch.hub.load('pytorch/vision:v0.14.1', 'resnet50', weights="IMAGENET1K_V1")
# model = torch.hub.load('pytorch/vision:v0.14.1', 'resnet101', weights="IMAGENET1K_V1")
# model = torch.hub.load('pytorch/vision:v0.14.1', 'resnet152', weights="IMAGENET1K_V1")
model.eval()
```
